...
const socialClass =
  "grid size-10 place-items-center rounded-full bg-blush text-primary-strong transition-colors hover:bg-primary hover:text-primary-foreground";
      ...
      <Container className="grid gap-10 py-14 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1.4fr] lg:gap-12 lg:py-16">
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <ul aria-label="Social media" className="mt-5 flex gap-3">
            {instagram ? (
              <li>
                <a href={instagram} target="_blank" rel="noopener noreferrer" aria-label="Sprinkle & Sparkle on Instagram" className={socialClass}>
                  <InstagramIcon aria-hidden className="size-[18px]" />
                </a>
              </li>
            ) : null}
            <li>
              <a href={whatsappHref} target="_blank" rel="noopener noreferrer" aria-label="Chat with us on WhatsApp" className={socialClass}>
